...
-(void)initRefrechView
{
   // [self setContentSize:CGSizeMake(self.bounds.size.width, self.bounds.size.height*1.5)];
    RefreshHeaderAndFooterView *view = [[RefreshHeaderAndFooterView alloc] initWithFrame:self.frame];
    [self addSubview:view];
    self.refreshView = view;
    [self.refreshView.refreshHeaderView updateRefreshDate:[NSDate date]];
